        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className="w-full sm:w-auto group relative px-6 py-3 border-2 border-gray-200 rounded-xl shadow-lg 
                transition-all duration-500 ease-in-out
                hover:shadow-xl hover:scale-102 hover:border-[#DAA520]
                ...
                disabled:hover:scale-100 disabled:hover:border-gray-200
