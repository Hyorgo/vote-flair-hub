...
export const Footer = () => {
  return (
    <footer className="relative mt-auto py-8 sm:py-12 bg-white/30 backdrop-blur-md border-t border-white/10 shadow-lg supports-[backdrop-filter]:bg-white/30">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 items-start"
        >
          <BrandingSection />
          <ContactLinks />
          <ServicesSection />
